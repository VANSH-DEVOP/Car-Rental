    ...
    <DefaultLayout>
      ...
      <Row justify="center" gutter={16}>
        <Col lg={16} sm={24}>
            ...
            {bookings.filter((o) => String(o.user) === String(user._id)).map((booking) => {
             return <Row key={booking._id} gutter={16} className="bs1 mt-3 text-left">
                <Col lg={6} sm={24}>
                ...
                <Col lg={6} sm={24} className='text-right'>
                    <img style={{borderRadius:5}} src={booking.car.image} alt={booking.car.name} height="140" className="p-2"/>
                </Col>
              </Row>;
            })}
